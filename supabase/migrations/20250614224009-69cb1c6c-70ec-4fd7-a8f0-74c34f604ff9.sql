...
-- Create subcategories table first
...
-- Now add subcategory_id column to products table
ALTER TABLE products ADD COLUMN subcategory_id UUID REFERENCES public.subcategories(id);
